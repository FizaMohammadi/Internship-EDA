...
# Main Title
st.markdown('<div class="main-title">Pixscribe App 📸😎🔊</div>', unsafe_allow_html=True)
st.markdown('<div class="subtitle">Shahleen\'s app transforms images into words with AI-powered text extraction and scene descriptions!</div>', unsafe_allow_html=True)
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> | ©️  SHAHLEEN | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
...
st.sidebar.markdown(
    ...
    <hr>
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> | ©️  FIZA MOHAMMADI | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)